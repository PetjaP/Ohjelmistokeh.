...
{
    public partial class AvainhenkilotForm : Form // Luo uudet data tablet
    {
        ...
        {
            string viite = oppilaitos.Rows[OppilaitosCB.SelectedIndex]["OID"].ToString(); // Mistä CB hakee datan
            OsoiteLB.Text = oppilaitos.Rows[OppilaitosCB.SelectedIndex]["OKatuosoite"].ToString(); // Mitä tässä kohtaa näytetään
            ...
            yhteys = vastuuhenkilot.Select("OID =" + viite).CopyToDataTable(); // Hakee tiedot ja tekee uuden taulukon
        ...
        private void AvainhenkilotForm_Load(object sender, EventArgs e)
        {
            ...
            OppilaitosCB.Datasource = oppilaitos; // Mistä CB hakee datan
            OppilaitosCB.DisplayMember = "ONimi"; // Mitä tässä kohtaa näytetään
        ...
        private void taytaOppilaitosTaulukko()
        {
            ...
            oppilaitos.Rows.Add(1, "StadinAO", "Hattulantie 2", "00550", "Helsinki", "09 310 8600"); // Nämä syötetään ylläolevaan
        ...
        private void VastuuhloCB_TextChanged(object sender, EventArgs e)
        {
            ...
            PuhelinLB.Text = yhteys.Rows[VastuuhenkiloCB.SelectedIndex]["VPuhelin"].ToString();
        }
    }
}